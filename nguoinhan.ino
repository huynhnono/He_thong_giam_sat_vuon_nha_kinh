...
const int OFF_MINUTE = 10;// Phút tắt bơm
...
//  return (irValue ==cb_Initial );  // Trả về true nếu phát hiện người
//}
//
//void openDoor() {
//  myservo.write(0);  // Điều khiển Servo quay về vị trí mở cửa
//}
//void closeDoor() {
//  myservo.write(90);  // Điều khiển Servo quay về vị trí đóng cửa
//}
...
void loop() {
  ...
  //delay(1000);
  float temperature1 = boardsStruct[0].temp; Serial.println(temperature1);
  float humidity1 = boardsStruct[0].hum;Serial.println(humidity1);
  float light1 = boardsStruct[0].lux;Serial.println(light1);
  int rain1 = boardsStruct[0].rain;Serial.println(rain1);
  int doamdat1 = boardsStruct[0].doamdat;Serial.println(doamdat1);
  float temperature2 = boardsStruct[1].temp;Serial.println(temperature2);
  float humidity2 = boardsStruct[1].hum;Serial.println(humidity2);
  float light2 = boardsStruct[1].lux;Serial.println(light2);
  ...
  //  // điều khiển tự động mở cửa
  //  if (detectPerson()) {  // Nếu phát hiện người
  //    openDoor();  // Mở cửa
